        ...
        try {
                ...
                if (errors.length == true)
                        ...
                        errors.forEach(element =>{
                                if(element != null){
                                        return res.json.status(200).json({message : element+" and the rest of the items added successfully"})
                                }
                                else{
                                        return res.json.status(401).json({message:"The product not found"})
                                }
                        })
                }
}            
